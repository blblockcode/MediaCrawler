...
# mysql config
MYSQL_DB_PWD = os.getenv("MYSQL_DB_PWD", "root_password")
...
REDIS_DB_PWD = os.getenv("REDIS_DB_PWD", "redis_password")  # your redis password
REDIS_DB_PORT = os.getenv("REDIS_DB_PORT", 6380)  # your redis port
